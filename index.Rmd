...
```{r visdatData, fig.cap='Visualization of Data Types', fig.height=3, fig.width=6}
vis_dat(board_games)
```

```{r vismissData, fig.cap='Visualization of Missing Values', fig.height=3, fig.width=6}
...
```{r visdatTop50, fig.cap='Visualization of Data Types in Top 50 Games', fig.height=3, fig.width=6}
vis_dat(board_games_top50)
```

```{r vismissTop50, fig.cap='Visualization of Missing Values in Top 50 Games', fig.height=3, fig.width=6}
