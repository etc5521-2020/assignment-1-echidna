...
```{r BoxplotCompare, fig.cap='Summarizing all observations as Violinplots'}
...
top10 %>% 
  ggplot(aes(x = reorder(designer,average_rating), y = average_rating)) +
  geom_segment( aes(xend=designer, yend=0)) +
...
top7 %>% 
  ggplot(aes(x = reorder(publisher,average_rating), y = average_rating)) +
  geom_segment(aes(xend=publisher, yend=0)) +
  geom_point(size=4, color="orange") +
  theme_bw() +
  coord_flip() +
