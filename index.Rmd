...
bpmaxplaytime <- board_games_top50 %>% ggplot() +
  geom_boxplot(mapping = aes(y= max_playtime), fill = "black") +
...
bpminplaytime <- board_games_top50 %>% ggplot() +
  geom_boxplot(mapping = aes(y= min_playtime), fill = "black") +
...
gridExtra::grid.arrange(bpminage, grid.arrange(bpmaxplayers, bpminplayers, bpmaxplaytime, bpminplaytime))
```
